...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::load_query_folders,
            commands::create_query_folder,
            commands::delete_query_folder,
            commands::rename_query_folder,
            commands::move_query_file,
